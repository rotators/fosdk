...
namespace FOnline
{
    public partial class Map
    {
        ...
        public virtual uint GetCrittersInPath(ushort from_hx, ushort from_hy, ushort to_hx, ushort to_hy, float angle, uint dist, Find find_type, IList<Critter> critters)
        {
            return Map_GetCrittersInPath(thisptr, from_hx, from_hy, to_hx, to_hy, angle, dist, (int)find_type, critters);
        }
        [MethodImpl(MethodImplOptions.InternalCall)]
        extern static uint Map_GetCrittersInPathBlock(IntPtr thisptr, ushort from_hx, ushort from_hy, ushort to_hx, ushort to_hy, float angle, uint dist, int find_type, IList<Critter> critters, out ushort pre_block_hx, out ushort pre_block_hy, out ushort block_hx, out ushort block_hy);
